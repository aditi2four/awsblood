...
<div class="col-12" style="height: 350px">
	...
	<div style="margin: 0; padding: 0 3% 0 9%; text-align: center;">
		<div class="col-11" style="background-color: #b3cccc; padding: 0">
			<div style="background-color: #75a3a3;overflow: auto;width: 100%; padding: 25px;">
				<form>
					<label><b><p style="font-size: 40px;">Select your blood group:</p></b></label>
			...
			<div id="txtHint" style="padding: 5% 0 5% 0; width: 100%; overflow: auto;">
