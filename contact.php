...
<br>
	<div style="margin: 0; padding: 0; text-align: center; overflow: auto;">
		...
		<div class="col-6" style="float: left; text-align: center; padding: 5%; background-color: rgb(217, 219, 224);">
		...
		<div class="col-3" style="width: 15%;float: right; background-color: rgb(217, 219, 224); overflow: auto; text-align: left; margin: 0 3% 3% 3%">
			...
			<div align="center" style="height: 120px; width: 120px;margin: 5%;margin-left: 20%"><img class="im" src="img16.png"></div>
			
			<p align="center" style="color: rgb(76, 109, 86); font-size: 20px;margin: 5%;">LTCOE</p>
			<p align="center" style="color: rgb(76, 109, 86); font-size: 20px;margin: 5%;">1234567890</p>
		</div>
	</div>
